...
{
  	while(I2C_GetFlagStatus(I2C1, I2C_FLAG_BUSY)==SET);//检测总线是否繁忙
	
	I2C_GenerateSTART(I2C1, ENABLE);//发送起始信号
	while(I2C_CheckEvent(I2C1, I2C_EVENT_MASTER_MODE_SELECT)==ERROR);//等待起始信号应答

	I2C_Send7bitAddress(I2C1, OLED_ADDRESS, I2C_Direction_Transmitter);//器件地址 -- 默认0x78
	while(I2C_CheckEvent(I2C1, I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED)==ERROR);//等待应答

	I2C_SendData(I2C1, addr);//寄存器地址
	while(I2C_CheckEvent(I2C1, I2C_EVENT_MASTER_BYTE_TRANSMITTED)==ERROR);//等待数据接收应答
